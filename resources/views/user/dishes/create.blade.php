                                ...
                                <form class="row g-2" action="{{ route('user.dishes.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <div class="input-group">
                                            <select class="form-select form-select-sm my-select text-secondary" name="genre_id" id="genre_id" value="{{ old('genre_id') }}" required>
                                                <option class="my-option" selected>Imposta il tipo di piatto...</option>
                                                @foreach ($genres as $genre)
                                                    <option class="my-option" value="{{ $genre->id }}">{{ $genre->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('genre_id')
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <div class="input-group">
                                            <select class="form-select form-select-sm my-select text-secondary" name="visible" id="visible" required>
