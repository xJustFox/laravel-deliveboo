                            ...
                            <div class="col-12">
                                <form class="row g-2" action="{{ route('user.dishes.store') }}" method="POST"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            <select class="form-select form-select-sm text-secondary" name="visible"
                                                id="visible" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="image" id="image"
                                            class="form-control form-select-sm" value="{{ old('image') }}" required>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-floating">
                                            <textarea name="description" class="form-control form-control-sm" placeholder="Leave a comment here" id="description"
                                                style="height: 100px">{{ old('description') }}</textarea>
                                            <label for="description" class="text-secondary d-none d-sm-block">Aggiungi una
                                                descrizione...</label>
                                        </div>
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
